# Count Digits
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number <strong>N</strong>. Count the number of digits in N which evenly divides N.</span></p>
